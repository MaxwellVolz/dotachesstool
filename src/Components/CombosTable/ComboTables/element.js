            ...
            <Table className={classes.table} id="comboTeamTable" padding="dense">
                <TableHead>
                    <TableRow className={classes.row}>
                        <TableCell className={classes.nopadding}>Elemental</TableCell>

                        <TableCell className={classes.nopadding}>Elemental Essence</TableCell>
                ...
                <TableBody>
                    <TableRow className={classes.row}>
                        ...
                        <TableCell
                            component="th"
                            className={classes.nopadding}> All friendly elementals have 30% chance to turn the attacker into stone for 4s when attacked by melee chesses.
                                    </TableCell>
                        <TableCell
                    ...
                    <TableRow className={classes.row}>
                        ...
                        <TableCell
                            component="th"
                            className={classes.nopadding}>All friendly chesses have 30% chance to turn the attacker into stone for 4s when attacked by melee chesses.
                                    </TableCell>
                        <TableCell
                            className={classes.nopadding}
                            onMouseEnter={this.toggleHoverEnter}
                            onMouseLeave={this.toggleHoverExit}>4
                                    </TableCell>
                        {/* <TableCell align="right" className="pieceCost">{row.cost}</TableCell> */}
                    </TableRow>
                </TableBody>
