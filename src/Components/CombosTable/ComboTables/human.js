            ...
            <Table className={classes.table} id="comboTeamTable" padding="dense">
                <TableHead>
                    <TableRow className={classes.row}>
                        <TableCell className={classes.nopadding}>Demons</TableCell>

                        <TableCell className={classes.nopadding}>Fel Power</TableCell>
                ...
                <TableBody>
                    <TableRow className={classes.row}>
                        ...
                        <TableCell
                            component="th"
                            className={classes.nopadding}>Active when you control only one demon on the chessboard.
                                    </TableCell>
                        <TableCell
